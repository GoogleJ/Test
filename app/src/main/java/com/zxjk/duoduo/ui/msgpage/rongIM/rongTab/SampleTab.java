package com.zxjk.duoduo.ui.msgpage.rongIM.rongTab;
            ...
            public AbstractHolder createHolder(View itemView) {
                return new AbstractHolder<ModelHomeEntrance>(itemView) {
                    ...
                    protected void initView(View itemView) {
                        ...
                        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, ScreenUtils.getScreenWidth() / 4);
